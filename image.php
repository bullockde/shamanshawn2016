...
get_header(); ?>
	...
	<div id="primary" class=" text-center image">
		<?php 
			// Parent post navigation.
					the_post_navigation( array(
						'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title text-center">%title</span>', 'Parent post link', 'twentysixteen' ),
					) );
		?> 
			...
			?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="">
						...
						<div class="entry-attachment col-md-8">
							<?php
								/**
